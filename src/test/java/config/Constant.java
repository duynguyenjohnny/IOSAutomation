...
public class Constant {
    ...
    public static final String APP_PATH="FoodyVN.apk";//com.android.chrome.apk//FoodyVN.apk
    public static final String APP_PACKAGE_LIVE = "com.foody.vn.activity.demo";
